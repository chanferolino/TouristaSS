...
public class RateTourGuideActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(Controllers.getPackRate()!=0&&Controllers.getRatingTG().size()!=0) {
...
//                obj.put("rating", Controllers.getPackRate());
//                obj.put("tourTransactionId", Controllers.getCurrentTransactionID());
